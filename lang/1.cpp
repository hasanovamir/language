...
// static tree_node_t* GetFunction      (const token_t* tokens, int* pos, int node_num);
// static tree_node_t* GetFooCall       (const token_t* tokens, int* pos, int node_num);
// static tree_node_t* GetFooCallParams (const token_t* tokens, int* pos, int node_num, int* params_count);
// static tree_node_t* GetFooParams     (const token_t* tokens, int* pos, int node_num, int* params_count);
...
//     tree_node_t* tree = GetG (tokens, &pos, node_num);
...
//         }
//         else if ((cur_node->right_node = GetFooCall (tokens, pos, node_num))) {
//             cur_node = cur_node->right_node;
//         }
...
//             cur_node = con;
//         }
//         else if ((cur_node->right_node = GetAnd (tokens, pos, node_num))) {
//             tree_node_t* con = NewNode (node_type_t::Connection, MakeDigitData (0), 
//                                         nullptr                , nullptr         );
//             con->left_node = cur_node->right_node;
...
// static tree_node_t*
// GetFooParams (const token_t* tokens, int* pos, int node_num, int* params_count)
// {
//     DEBUG_ASSERT (tokens != nullptr);
...
// static tree_node_t*
// GetFunction (const token_t* tokens, int* pos, int node_num)
// {
//     DEBUG_ASSERT (tokens != nullptr);
...
//         tree_node_t* foo_params = GetFooParams (tokens, pos, node_num, &params_count);
...
//         tree_node_t* function_content = GetFigBracket (tokens, pos, node_num);
...
//             cur_node = cur_node->right_node;
//         }
//         else if ((cur_node->right_node = GetFunction (tokens, pos, node_num))) {
//             tree_node_t* con = NewNode (node_type_t::Connection, MakeDigitData (0), 
//                                         nullptr                , nullptr         );
...
// static tree_node_t*
// GetFooCall (const token_t* tokens, int* pos, int node_num)
// {
//     DEBUG_ASSERT (tokens != nullptr);
...
//     tree_node_t* foo_params = GetFooCallParams (tokens, pos, node_num, &foo_params_count);
...
// static tree_node_t*
// GetFooCallParams (const token_t* tokens, int* pos, int node_num, int* params_count)
// {
//     DEBUG_ASSERT (tokens != nullptr);
...
//         cur_node = GetAnd (tokens, pos, node_num);
...
//             cur_var->right_node = GetAnd (tokens, pos, node_num);
